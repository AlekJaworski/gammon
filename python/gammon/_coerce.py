"""Shared coercion helpers + the v0.x family-name → gammon-native
...
# Family name → (gammon_native family_name, canonical_link). The native
# dispatcher accepts each value below; the link arg is informational
# at the Python wrapper layer.
FAMILY_TO_GAMMON: dict[str, tuple[str, str]] = {
